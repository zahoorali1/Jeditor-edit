...
//        String toDate = dateTo.getText();
//        boolean useDateFilter = !fromDate.isEmpty() && !toDate.isEmpty();
//        if (useDateFilter) {
...
//
//                Date fileModDate = new Date(lastModified);
//
//            }
...
//            add(dateTo);
		...
		searchSettings.add(dateFrom);
            searchSettings.add(new JLabel("")); // Empty label for spacing
		searchSettings.add(new JLabel("Modified to:"));
		 dateTo = new JTextField(10); // Create the "Modified to" date field
		searchSettings.add(dateTo);
